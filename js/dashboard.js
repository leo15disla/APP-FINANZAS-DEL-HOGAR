...
function renderChartIngGastos(ctx, ingresosData, gastosData, labels, balanceData) {
  ...
  chartIngGastos = new Chart(ctx, {
    ...
    data: {
      labels,
      datasets: [
        { label: 'Ingresos', data: ingresosData, backgroundColor: '#7A4DFF', hoverBackgroundColor: 'rgba(122,77,255,0.9)' },
        { label: 'Gastos', data: gastosData, backgroundColor: '#FF4F9A', hoverBackgroundColor: 'rgba(255,79,154,0.9)' },
        {
          label: 'Balance acumulado',
          data: balanceData,
          type: 'line',
          borderColor: '#5A30E0',
          backgroundColor: 'rgba(122, 77, 255, 0.12)',
          tension: 0.35,
          fill: false,
          borderWidth: 2.5,
          pointRadius: 3.5,
