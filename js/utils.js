...
export function resolveTheme(preference = state.settings?.tema || 'auto') {
...
export function applyTheme(preference = 'auto') {
  ...
  if (state.settings) {
    state.settings.tema = preference;
    refreshStorage();
  }
  document.body.dispatchEvent(
    new CustomEvent('theme-changed', { detail: { theme: resolved, preference } })
  );
}
